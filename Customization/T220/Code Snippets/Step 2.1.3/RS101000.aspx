...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="Setup" Width="100%" AllowAutoHide="false">
		<Template>
			...
			<px:PXSelector runat="server" ID="CstPXSelector2" DataField="NumberingId" />
			<px:PXNumberEdit runat="server" ID="CstPXNumberEdit3" DataField="PrepaymentPercent" />
			<px:PXSegmentMask runat="server" ID="CstPXSegmentMask4" DataField="WalkInCustomerID" /></Template>
